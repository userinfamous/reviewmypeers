...
SECRET_KEY = 'django-insecure-f@61smslyi#guu+!oiy)@5a(ng8xy#%l5%d_9t(92b_9-dd=#x'
# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True
ALLOWED_HOSTS = ['reviewmypeers-production.up.railway.app', 'localhost', '127.0.0.1']
...
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR / 'templates')],  # This tells Django to look for templates in the BASE_DIR / 'templates' directory.
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                'django.template.context_processors.debug',
